...
def Details() :
    ...
    if request.method == 'POST' and 'Username' in request.form and 'aptNo' in request.form and 'TFatherName' in request.form and 'PerAddr' in request.form :
        ...
        if t_id != None and res1 != None :
            ...
            Deposit = rentAmt * 2
            return redirect(url_for('Contract', Uname=Uname,aptNo=aptNo ,Tname=Tname, TFatherName=TFatherName, PAddress=PAddress, Date=Date, rentAmt=rentAmt, Deposit=Deposit))
        else :
